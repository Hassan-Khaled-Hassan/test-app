...
import { Alert, Box, Button, Dialog,InputLabel,Select, DialogContent,FormControl,FormHelperText, IconButton, InputAdornment, MenuItem, Snackbar, Stack, TextField } from "@mui/material";
        ...
        <Stack sx={{ gap: 2, flexDirection: { xs: "column", md: "row" } }}>
          <FormControl sx={{ width: { xs: "100%", md: "90%" } }}>
            <Controller
              name="images"
              control={control}
              defaultValue={{}} // Default value as an empty object for MultiImageInput
              rules={{
                validate: (value) =>
        ...
        >
          <FormControl sx={{
            ...
            <CssTextField
              ...
              helperText={
                errors.Requirements ? `Full Name is required. ` : null
              }
